...
// appels (empilement d'un mot (= 1 pointeur) au lieu de quatre sinon
// (= 1 par champs).
...
// variable T comme "char * T;" alors T est une variable de type
// "char" (avec sizeof(T) = 1 pointeur = 8) et *T est une variable de
// type "char" (avec sizeof(*T) = 1).
